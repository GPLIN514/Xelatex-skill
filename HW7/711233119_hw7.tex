...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.8]{\imgdir la1scatter.png}}
    \caption{資料1散佈圖}
    \label{fig:資料1散佈圖}
\end{figure}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.8]{\imgdir la7scatter.png}}
    \caption{資料7散佈圖}
    \label{fig:資料7散佈圖}
\end{figure}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.8]{\imgdir la8scatter.png}}
    \caption{資料8散佈圖}
    \label{fig:資料8散佈圖}
\end{figure}
