...
%---置入定義檔 ----------------------------------
\input{preamble_GP_book} % the image directory may be changed.		
\input{preamble_addon_Book}  
\input{preamble_addon_counter}  	
	
				
\usepackage{wallpaper} %浮水印
\CenterWallPaper{0.7}{\imgdir wall_paper.png}
\URCornerWallPaper{0.15}{\imgdir 小小標.png}
...
\begin{figure}[h]
    \centering
        \includegraphics[scale=13]{\imgdir ai機器人.png}%封面圖片不是放在graph下面，利用新指令指到正確位置
    \end{figure}
...
\newpage
%--- 放入各章 -----------------------------------
\include{711233119_hw0_book.tex} 	% 序言
...
\include{711233119_hw1_book.tex}
\include{711233119_hw2_book.tex}
\include{711233119_hw3_book.tex}
\include{711233119_hw4_book.tex}
\include{711233119_hw5_book.tex}
\include{711233119_hw6_book.tex}
\include{711233119_hw7_book.tex}
%-------Reference--------------------------------------------------------------------------------------------
