...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.25]{\imgdir five-characteristic .jpeg}}
    \caption{五大特色圖}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.25]{\imgdir 區塊鏈1.png}}
    \caption{區塊鏈驗證}
    \label{fig:區塊鏈驗證}
\end{figure}
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.25]{\imgdir 區塊鏈2.png}}
    \caption{區塊鏈驗證過程}
    \label{fig:區塊鏈驗證過程}
\end{figure}
\subsection{Gas}
...
\bottomrule
\end{longtable}
通常這些Gas會被發送到礦工的帳戶地址，就是剛剛說的驗證這筆交易的人的獎勵，所以如果發送方願意支付的Gas價格越高，礦工所獲得的價值就越多，會有更多或比較厲害的礦工優先選擇他，因為礦工是可以選擇要驗證哪些交易或忽略哪些交易的。至於GAS發送有下面兩種狀況：\\
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.56]{\imgdir Gas1.png}}
    \caption{Gas Enough}
    \label{fig:Gasenough}
\end{figure}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.6]{\imgdir Forks.png}}
    \caption{Forks}
    \label{fig:Forks}
\end{figure}
\subsection{私鑰公鑰地址}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.55]{\imgdir 私鑰公鑰地址.png}}
    \caption{私鑰公鑰地址}
    \label{fig:pkpkadd}
\end{figure}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.5]{\imgdir 公私鑰示意圖1.png}}
    \caption{公私鑰示意圖狀況1}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.55]{\imgdir 公私鑰示意圖2.png}}
    \caption{公私鑰示意圖狀況2}
...
\end{itemize}
\subsection{離散均勻分配(Discrete Uniform distribution)}
\begin{itemize}
...
\end{enumerate}
\subsection{Zeta分配(Zeta distribution)}
\begin{itemize}
...
\end{table}
\newpage
\subsection{均勻分配(Uniform distribution)}
\begin{itemize}
...
\end{enumerate}
\subsection{多維度常態分配(Multivariate Normal distribution)}
\begin{enumerate}
...
\end{enumerate}
\subsection{韋伯分配(Weibull distribution)}
\begin{enumerate}
