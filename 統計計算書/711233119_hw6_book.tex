...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.8]{\imgdir 前饋式類神經網路示意圖.png}}
    \caption{前饋式類神經網路示意圖}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.75]{\imgdir ann3.png}}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.465]{\imgdir ann5.png}}
    \caption{不同演算法的配適表現}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.65]{\imgdir ann6.png}}
    \caption{均勻落在扇形區的亂數}
    \label{fig:均勻落在扇形區的亂數}
\end{figure}
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.56]{\imgdir ann7.png}}
    \caption{均勻落在圓形區的亂數}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.45]{\imgdir trainBFGS.png}}
    \caption{LBFGS演算法不同樣本神經元個數的比較}
    \label{fig:LBFGS演算法不同樣本神經元個數的比較}
\end{figure}
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.45]{\imgdir trainBFGSde.png}}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.5]{\imgdir traincg.png}}
    \caption{CG演算法不同樣本神經元個數的比較}
    \label{fig:CG演算法不同樣本神經元個數的比較}
\end{figure}
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.45]{\imgdir traincgde.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.7]{\imgdir 手寫數字辨識數量.png}}
    \caption{手寫數字辨識總數}
    \label{fig:手寫數字辨識數量}
\end{figure}
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.7]{\imgdir 手寫數字辨識準確率.png}}
    \caption{手寫數字辨識準確率}
    \label{fig:手寫數字辨識準確率}
\end{figure}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=1.1]{\imgdir 手寫字母.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.7]{\imgdir 手寫字母辨識數量.png}}
    \caption{手寫字母辨識總數}
    \label{fig:手寫字母辨識數量}
\end{figure}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.7]{\imgdir 手寫字母辨識準確率.png}}
    \caption{手寫字母辨識準確率}
    \label{fig:手寫字母辨識準確率}
\end{figure}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.65]{\imgdir 手寫字母辨識損失函數.png}}
    \caption{手寫字母辨識損失函數}
