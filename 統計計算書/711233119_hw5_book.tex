\chapter{探索監督式學習分類器：LDA、QDA、KNN}
...
假設我們有一個新的未標記樣本，想要確定它應該被歸類為藍色還是綠色。圖 \ref{fig:knn示意圖} (a) 以一個直觀的示意圖呈現了情境，其中我們引入了一個新的樣本。為了確定新樣本的類別歸屬，KNN演算法會開始計算它與鄰近幾個樣本的距離(如圖 \ref{fig:knn示意圖} (b) 所示)。這些鄰近的樣本即為KNN的鄰居。計算過後，我們發現新樣本附近的樣本中綠色的比藍色的多。因此，KNN將新樣本歸類在綠色的類別中(如圖 \ref{fig:knn示意圖} (c) )。
...
\begin{figure}[H]
    \centering
        \subfloat[未受標記的新樣本]{
        \includegraphics[scale=0.4]{\imgdir knn示意圖1.png}}\\
        \subfloat[計算相鄰樣本的距離]{
        \includegraphics[scale=0.4]{\imgdir knn示意圖2.png}}
        \subfloat[歸類於所屬類別]{
        \includegraphics[scale=0.4]{\imgdir knn示意圖3.png}}
    \caption{KNN示意圖}
    \label{fig:knn示意圖}
\end{figure}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.8]{\imgdir la1lda.png}}
    \caption{資料1-LDA}
    \label{fig:la1-LDA}
\end{figure}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.7]{\imgdir la3lda.png}}
    \caption{資料3-LDA}
    \label{fig:3-LDA}
\end{figure}
\begin{figure}[H]
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.5]{\imgdir la4ldaqdaknn.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.5]{\imgdir la5ldaqdaknn.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.5]{\imgdir la6ldaqdaknn.png}}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.5]{\imgdir la7ldaqdaknn.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.52]{\imgdir la8ldaqdaknn.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.5]{\imgdir la9ldaqdaknn.png}}
