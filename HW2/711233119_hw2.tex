...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.8]{\imgdir exp_1.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.75]{\imgdir exp_sin.png}}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.8]{\imgdir fraction.png}}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.8]{\imgdir FF.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.8]{\imgdir lnfr_1.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.8]{\imgdir lnfr_2.png}}
    \caption{$f(x) = \frac{ln(x)}{x^2}$}
    \label{fig:lnfr_2}
\end{figure}
此節較特殊的程式碼：
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.8]{\imgdir Sn.png}}
    \caption{$S_n$的發散特性}
    \label{fig:Sn}
\end{figure}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.9]{\imgdir riemannsum.png}}
    \caption{$\gamma_n=$ sum of the orange area}
    \label{fig:riemannsum}
\end{figure}
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.62]{\imgdir markdownriemannsum.png}}
...
\begin{figure}[H]
    \centering{
        \includegraphics[scale=0.765]{\imgdir gamman_1.png}}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=0.765]{\imgdir gamman_2.png}}
...
\begin{figure}[h]
    \centering{
        \includegraphics[scale=1]{\imgdir ferriswheel_2.png}}
    \caption{真實摩天輪}
